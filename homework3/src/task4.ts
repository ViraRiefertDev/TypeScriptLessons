...
if (confirm('Почати тестування?')) {
  type Book = {type:'book'; author:string}
  type Electronics = {type:'electronics'; warranty: string}
  type Clothes = {type: 'clothes'; size:string}
  ...
  const electronic:ShopProduct ={
    type: 'electronics',
    warranty: 'bis 20.08.2027',
    status:'onSale'
  }

  const rock:ShopProduct = {
    type:'clothes',
    size: 'M',
    status:'onSale'
  }

  const products:ShopProduct[] = [book,electronic,rock]
