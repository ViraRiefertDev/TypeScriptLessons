...
if (confirm('Почати тестування?')) {
  ...
  try{
    const ticket:unknown = {destination:'Kyiv',price:500,passengerName:'Vira Riefert',date:new Date()}
    ...
    const ticket2:unknown = {destination:'Kyiv',price:500,passengerName:'Vira Riefert',date:'22.03.1994'}
